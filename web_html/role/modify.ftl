        ...
        <form action="" id="form_data" method="post" class="layui-form layui-form-pane">
            ...
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    <textarea placeholder="请输入内容" id="desc" name="desc" lay-verify="required" class="layui-textarea">${(role.desc)!''}</textarea>
                </div>
            </div>
            <div class="layui-form-item">
                <button class="layui-btn" lay-submit="" id="modify" lay-filter="modify">修改</button>
            </div>
        </form>
    </div>
</div>
...
<script type="text/javascript">
    ...
    layui.use(['tree', 'util'], function(){
        ...
        form.on('submit(modify)', function(data){
            ...
            //ajax 异步提交
            $.ajax({
                url : '${path}${Session["sys:role:modify"]}',
                type : 'POST',
                dataType : 'json',
