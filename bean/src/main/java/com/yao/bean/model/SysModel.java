...
public class SysModel {
    ...
    public void setLastAuditOperId(String lastAuditOperId) {
        this.lastAuditOperId = lastAuditOperId;
    }

    public String getLastAuditOperDate() {
        return lastAuditOperDate;
    }

    public void setLastAuditOperDate(String lastAuditOperDate) {
